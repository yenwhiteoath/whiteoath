...
- [Learning LLVM (Part-1) - Writing a simple LLVM pass](https://sh4dy.com/2024/06/29/learning_llvm_01/)
- [A tour of the LLVM backend](https://artagnon.com/computing/compilers/backend) 
...
- [Embedded in Academia blog](https://blog.regehr.org/archives/category/compilers)
- [Clang Tutorial: Finding Declarations](https://xinhuang.github.io/posts/2014-10-19-clang-tutorial-finding-declarations.html)
- [Notes/Primer on Clang Compiler Frontend](https://youssefaa.com/notes/)
- [Linear scan register allocation on SSA](https://bernsteinbear.com/blog/linear-scan/)
